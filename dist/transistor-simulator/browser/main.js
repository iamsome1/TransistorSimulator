...
var routes = [
  ...
  {
    path: "home",
    loadComponent: () => import("./chunk-DWWBBOSK.js").then((m) => m.HomeComponent),
    title: "Transistor Simulator \u2014 Home"
  },
  {
    path: "binary-basics",
    loadComponent: () => import("./chunk-6MPHZ3FJ.js").then((m) => m.BinaryBasicsComponent),
    title: "Binary Basics"
  },
  {
    path: "gate-playground",
    loadComponent: () => import("./chunk-LPNNGNUK.js").then((m) => m.GatePlaygroundComponent),
    title: "Gate Playground"
  },
  {
    path: "half-adder",
    loadComponent: () => import("./chunk-BY37QNVX.js").then((m) => m.HalfAdderComponent),
    title: "Half Adder"
  },
  {
    path: "full-adder",
    loadComponent: () => import("./chunk-ZZYN2P7C.js").then((m) => m.FullAdderComponent),
    title: "Full Adder"
  },
  {
    path: "ripple-carry",
    loadComponent: () => import("./chunk-NII273PP.js").then((m) => m.RippleCarryComponent),
    title: "Ripple Carry Adder"
  },
  {
    path: "transistor",
    loadComponent: () => import("./chunk-A6P3QRI4.js").then((m) => m.TransistorConceptComponent),
    title: "Transistor Concept"
  },
  {
    path: "quiz",
    loadComponent: () => import("./chunk-LZVABU5O.js").then((m) => m.QuizComponent),
    title: "Quiz"
  },
...
function AppComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AppComponent_Conditional_10_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function AppComponent_For_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AppComponent_For_24_Template_a_click_1_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeSidebar());
    });
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 21)(5, "span", 22);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r4.sublabel);
  }
}
var AppComponent = class _AppComponent {
  constructor() {
    ...
    this.navItems = [
      { path: "home", label: "Introduction", icon: "\u{1F3E0}", sublabel: "Start here" },
      { path: "binary-basics", label: "Binary Basics", icon: "\u{1F522}", sublabel: "Decimal \u2192 Binary" },
      ...
      { path: "full-adder", label: "Full Adder", icon: "\u{1F501}", sublabel: "With carry-in" },
      { path: "ripple-carry", label: "Ripple Carry", icon: "\u{1F30A}", sublabel: "4-bit / 8-bit" },
      { path: "transistor", label: "Transistors", icon: "\u{1F52C}", sublabel: "The tiny switches" },
      { path: "quiz", label: "Quiz", icon: "\u{1F3AF}", sublabel: "Test yourself" }
    ];
  }
  toggleSidebar() {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], hostBindings: function AppComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275listener("keydown.escape", function AppComponent_keydown_escape_HostBindingHandler() {
          return ctx.onEscape();
        }, false, \u0275\u0275resolveDocument);
      }
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 30, vars: 4, consts: [[1, "app-shell"], [1, "topbar"], ["aria-label", "Menu", 1, "btn", "btn-icon", "topbar-menu", 3, "click"], ["width", "20", "height", "20", "viewBox", "0 0 20 20", "fill", "none"], ["d", "M4 4l12 12M16 4L4 16", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round"], [1, "topbar-title"], [1, "chip-icon"], [1, "sidebar-backdrop"], ["role", "navigation", "aria-label", "Main navigation", 1, "sidebar"], [1, "sidebar-brand"], [1, "brand-icon"], [1, "brand-title"], [1, "brand-sub"], [1, "nav-list"], [1, "sidebar-footer"], [1, "text-muted", "text-xs"], [1, "main-content"], ["d", "M3 5h14M3 10h14M3 15h14", "stroke", "currentColor", "stroke-width", "2", "stroke-linecap", "round"], [1, "sidebar-backdrop", 3, "click"], ["routerLinkActive", "active", 1, "nav-item", 3, "click", "routerLink"], [1, "nav-icon"], [1, "nav-text"], [1, "nav-label"], [1, "nav-sub"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "button", 2);
        \u0275\u0275listener("click", function AppComponent_Template_button_click_2_listener() {
          return ctx.toggleSidebar();
        });
        \u0275\u0275namespaceSVG();
        \u0275\u0275elementStart(3, "svg", 3);
        \u0275\u0275template(4, AppComponent_Conditional_4_Template, 1, 0, ":svg:path", 4)(5, AppComponent_Conditional_5_Template, 1, 0);
        \u0275\u0275elementEnd()();
        \u0275\u0275namespaceHTML();
        \u0275\u0275elementStart(6, "span", 5)(7, "span", 6);
        \u0275\u0275text(8, "\u26A1");
        \u0275\u0275elementEnd();
        \u0275\u0275text(9, " Transistor Sim ");
        \u0275\u0275elementEnd()();
        \u0275\u0275template(10, AppComponent_Conditional_10_Template, 1, 0, "div", 7);
        \u0275\u0275elementStart(11, "nav", 8)(12, "div", 9)(13, "div", 10);
        \u0275\u0275text(14, "\u26A1");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(15, "div")(16, "div", 11);
        \u0275\u0275text(17, "Transistor");
        \u0275\u0275element(18, "br");
        \u0275\u0275text(19, "Simulator");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(20, "div", 12);
        \u0275\u0275text(21, "Interactive Learning");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(22, "ul", 13);
        \u0275\u0275repeaterCreate(23, AppComponent_For_24_Template, 9, 4, "li", null, _forTrack0);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(25, "div", 14)(26, "span", 15);
        \u0275\u0275text(27, "v1.0 \xB7 Angular 17 \xB7 Signals");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(28, "main", 16);
